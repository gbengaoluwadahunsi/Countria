    ...
    if (country) {
      ...
      axios
        ...
        .then((countryResponse) => {
          ...
          return axios.get(
            `https://api.weatherapi.com/v1/current.json?key=72c7356ce4ce485ea84120905240601&q=${capital}&aqi=no`
          );
        })
  ...
  return (
    <>
      <form className="search-section" onSubmit={onSearch}>
        <label htmlFor="find" className="type-country">
          Type country ...{" "}
        </label>
      ...
      <section className="carousel">
        <h4>
          We offer information about countries and predicted weather data via
          light-speed APIs for every location on the planet. Forecast updated
          every minute. Additional forecasts: 24-hour, 16-hour, and 30-day
          climate forecasts.
        </h4>
        <CarouselComponent />
      </section>
